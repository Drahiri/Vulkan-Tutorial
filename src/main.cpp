...
const std::string MODEL_PATH = "assets/VikingRoom/viking_room.obj";
const std::string TEXTURE_PATH = "assets/VikingRoom/viking_room.png";
...
private:
    ...
    void createSwapchainImageViews() {
        ...
        for(size_t i = 0; i < swapchainImages.size(); ++i) {
            swapchainImageViews[i] = createImageView(
                  swapchainImages[i], 1, swapchainFormat, VK_IMAGE_ASPECT_COLOR_BIT);
        }
    }

    VkImageView createImageView(
          VkImage image, uint32_t mipLevels, VkFormat format, VkImageAspectFlags aspectFlags) {
    ...
    void createTextureImageView() {
        textureImageView =
              createImageView(textureImage, 1, VK_FORMAT_R8G8B8A8_SRGB, VK_IMAGE_ASPECT_COLOR_BIT);
    }
    ...
    void createDescriptorSets() {
        ...
        if(vkAllocateDescriptorSets(device, &allocInfo, descriptorSets.data()) != VK_SUCCESS) {
            throw std::runtime_error("Failed to allocate Description Sets");
        }
    ...
    // TODO: Try to implement suggestion from
